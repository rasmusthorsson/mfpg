...
execute_process(
	COMMAND ${MFPG_PATH} -t 1 -o ${CMAKE_BINARY_DIR}/A_D_o_F_config.csv --format=csv --greedy
			../tests/cases/A_D_o_F.xml)

execute_process(
	COMMAND ${MFPG_PATH} -t 1 -o ${CMAKE_BINARY_DIR}/A_W_config.csv --format=csv --greedy
			../tests/cases/A_W.xml)

execute_process(
	COMMAND ${MFPG_PATH} -t 1 -o ${CMAKE_BINARY_DIR}/A_W_config_sps.csv --format=csv --shortest-path=2
			../tests/cases/A_W.xml)

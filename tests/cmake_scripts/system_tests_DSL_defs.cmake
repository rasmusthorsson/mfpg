...
execute_process(
	COMMAND ${MFPG_PATH} -d ../resources/dsl_files/DSL_test_configuration_defs.mfpg -o ${CMAKE_BINARY_DIR}/A_D_o_F_defs.csv --csv --shortest-path=2
			../tests/cases/A_D_o_F.xml)

execute_process(
	COMMAND ${MFPG_PATH} -d ../resources/dsl_files/DSL_test_configuration_defs.mfpg -o ${CMAKE_BINARY_DIR}/A_W_defs.csv --csv --shortest-path=2
			../tests/cases/A_W.xml)


execute_process(
	COMMAND ${CMAKE_COMMAND} -E compare_files --ignore-eol ${CMAKE_BINARY_DIR}/A_W_defs.csv

...
namespace configs {
	...
	ActionSet<Node_Tuple, Distance>* test_configuration_2() {
		...
		const Action<Node_Tuple, Distance> rest(rest_c, rest_d, "rest");
		...
		const Action<Node_Tuple, Distance> f_a(f_a_c, f_a_d, "f_a");
		...
		const Action<Node_Tuple, Distance> s_a_cross(s_a_cross_c, 
							     s_a_cross_d, 
							     "s_a_cross");
		...
		const Action<Node_Tuple, Distance> s_a_no_cross(s_a_no_cross_c, 
								s_a_no_cross_d, 
								"s_a_no_cross");
		...
		const Action<Node_Tuple, Distance> hp_a_no_change(hp_a_no_change_c, 
								  hp_a_no_change_d, 
								  "hp_a_no_change");
		...
		const Action<Node_Tuple, Distance> hp_a_short(hp_a_short_c, 
							      hp_a_short_d, 
							      "hp_a_short");
		...
		const Action<Node_Tuple, Distance> hp_a_long(hp_a_long_c, 
							     hp_a_long_d, 
							     "hp_a_long");
	...
	ActionSet<Node_Tuple, Distance>* test_configuration_1() {
		...
		const Action<Node_Tuple, Distance> hp_action(hp_action_cond, 
							     hp_action_dist, 
							     "hp_action");
		...
		const Action<Node_Tuple, Distance> finger_action(finger_action_cond, 
								  finger_action_dist, 
								  "finger_action");
		...
		const Action<Node_Tuple, Distance> string_action_NR(
							string_action_NR_cond, 
		...
		const Action<Node_Tuple, Distance> string_action(string_action_cond, 
								 string_action_dist, 
								 "string_action");
		...
		const Action<Node_Tuple, Distance> rest(rest_cond, 
							rest_dist, 
							"rest");

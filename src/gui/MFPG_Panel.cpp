...
//----------------------------------------------INSTRUMENT SETTINGS-------------------------------------
	...
	instrument_box = new wxComboBox(instrument_area, ID_CBInstrument, _T("Violin"), wxPoint(20, 35), 
		wxSize(160, 40), 2, inst_choices, wxCB_READONLY, wxDefaultValidator, wxComboBoxNameStr);
	//Text: ActionSet
	...
	//Box: Area for DSL file selection
	wxStaticBox *dsl_box = new wxStaticBox(instrument_area, wxID_ANY, "DSL File", wxPoint(20, 80),
		wxSize(360, 80), 0, wxStaticBoxNameStr);
	//File Selection: DSL
	dsl_filepicker = new wxFilePickerCtrl(dsl_box, ID_FPDSL, wxEmptyString, wxFileSelectorPromptStr, 
		_("MFPG Files (*.mfpg)|*.mfpg"), wxPoint(20, 10), wxSize(320, 40), 
...
//-----------------------------------------NOTE MAPPER SETTINGS----------------------------------------
	...
	notemap_area = new wxStaticBox(this, wxID_ANY, "Note Mapper", wxPoint(10, 240), wxSize(400, 200), 
...
//-------------------------------------------FILES AREA-------------------------------------------
	...
	save_file_button = new wxButton(files_area, ID_BTSavetext, "Save File", wxPoint(100, 590), 
		wxSize(80, 30), 0, wxDefaultValidator, "SAVETEXT_BUTTON");
	//Button: Save as file
	save_as_file_button = new wxButton(files_area, ID_BTSaveastext, "Save as File", wxPoint(200, 590), 
		wxSize(80, 30), 0, wxDefaultValidator, "SAVEASTEXT_BUTTON");
	//Book: Files book
	...
	//TODO MOVE THIS TO SAVEBUTTON IN THE SAME WAY SAVEASBUTTON WAS MADE
	//Dialog: Save File Question
	save_file_dialog = new wxMessageDialog(files_area, "Save File?", "Save Confirmation", 
